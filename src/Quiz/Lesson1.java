...
public class Lesson1 extends JFrame {
	 ...
	 * @param username 
	 */
	public Lesson1(String username) {
        ...
        JPanel contentPane = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                Image backgroundImage = new ImageIcon("Resources\\Lesson1BG.png").getImage();
...
//        });
        ...
        btnBack.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                LearningMaterial frame = new LearningMaterial(username);
        ...
        btnLessons.setIcon(new ImageIcon("Resources\\learnNext.png"));
        btnLessons.setBounds(1050, 720, 357, 129);
