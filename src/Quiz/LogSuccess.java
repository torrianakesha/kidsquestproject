...
public class LogSuccess extends JFrame {
	 ...
	 * @param username 
	 */
	public LogSuccess(String username) {
        ...
        JPanel contentPane = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                Image backgroundImage = new ImageIcon("Resources\\logSuccBG.png").getImage();
        ...
        btnProcc.setBounds(513, 470, 475, 159); // Position the Register button
