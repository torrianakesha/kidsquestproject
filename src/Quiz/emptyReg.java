...
public class emptyReg extends JFrame {
	...
	public emptyReg() {
        ...
        JPanel contentPane = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                Image backgroundImage = new ImageIcon("Resources\\emptyRegBG.png").getImage();
        ...
        btnRegis.setIcon(new ImageIcon("Resources\\btnOk.png"));
        btnRegis.setFocusPainted(false);
        btnRegis.setContentAreaFilled(false);
        btnRegis.setBorderPainted(false);
        btnRegis.setBounds(489, 464, 520, 145); // Position the Register button
